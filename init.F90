...
USE GLOBAL;     USE NAMESC; USE GEOMC;  USE LOGICC; USE PREC;  USE SURFHE;  USE KINETIC; USE SHADEC; USE EDDY
  ...
  USE INITIALVELOCITY; USE BIOENERGETICS
  IMPLICIT NONE
...
! Kinetic flux variables
  ...
  KFNAME(63) = 'DO CBOD uptake - sink, kg/day                '; KFNAME(64) = 'DO reaeration - source, kg/day                '
...
! v3.5 start
  ...
  KFNAME(98) = 'Sediment epiphyton C settling - source,kg/day'; KFNAME(121)='CO2 gas exchange across air/water interface, kg/day'
