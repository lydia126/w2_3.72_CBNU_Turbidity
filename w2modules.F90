...
!**  restricted by the Export Administration Act of 1969,  50 app. USC subsections 24 01-2420, as amended, and other applicable   **
!**  laws or regulations.                                                                                                         **
!**                                                                                                                               **
!***********************************************************************************************************************************
...
MODULE GLOBAL
  ...
  REAL(R8)                                           :: G,PI
  REAL(R8)                                           :: DENSITY
  DATA                                        NDC /24/, NHY /15/, NFL /121/      ! cb 6/6/10    !CSW 7/20/2021
...
MODULE KINETIC
  ...
  REAL,    POINTER,               DIMENSION(:,:)     :: APR,    CHLA,   ATOT,   NTU        !CSW 7/20/2021
  ...
  REAL,              ALLOCATABLE, DIMENSION(:)       :: SSS,    TAUCR,  POMS,   FES, seds, sedb, NTUISS, NTUPOM !, SSFLOC  !cb 11/27/06 !SR 04/21/13   !CSW 7/20/2021
  REAL,              ALLOCATABLE, DIMENSION(:)       :: AG,     AR,     AE,     AM,     AS,     AHSN,   AHSP,   AHSSI,  ASAT
  REAL,              ALLOCATABLE, DIMENSION(:)       :: AP,     AN,     AC,     ASI,    ACHLA,  APOM,   ANPR, NTUALG  !CSW 7/20/2021
  ...
  REAL(R8),          ALLOCATABLE, DIMENSION(:)       :: BETA,   EXH2O,  EXSS,   EXOM,   EXA, NTUINT   !CSW 7/20/2021
