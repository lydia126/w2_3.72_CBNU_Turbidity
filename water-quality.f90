...
ENTRY DERIVED_CONSTITUENTS
  APR = 0.0; ATOT = 0.0; TOTSS = 0.0; CHLA = 0.0; CBODU=0.0;  NTU =0.0   ! CSW 7/20/2021
  DO JW=1,NWB
    KT = KTWB(JW)
    DO JB=BS(JW),BE(JW)
      DO I=CUS(JB),DS(JB)
        ...
        DO K=KT,KB(I)
          ...
          DO JS=1,NSS
            ...
            NTU(K,I) = NTU(K,I) +  SS(K,I,JS)*NTUISS(JS)   !CSW 7/20/2021
          END DO
          ...
          IF(ALG_CALC(JA))THEN
            ...
            NTU(K,I) = NTU(K,I) + ALG(K,I,JA)*NTUALG(JA)    !CSW 7/20/2021
          ENDIF
          END DO
