...
!***********************************************************************************************************************************
  ...
  IF (TIME_SERIES) THEN
    DO J=1,NIKTSR
      CLOSE (TSR(J))
    END DO
    close(9526)   ! WL output file  ! SW 9/25/13
  END IF
  ...
  DEALLOCATE (EXH2O,  BETA,   EXOM,   EXSS,   DXI,    CBHE,   TSED,   TSEDF,  FI,   NTUINT, ICET2,  AZC,    AZMAX,  QINT,   QOUTT)   !CSW 7/20/2021
  ...
  DEALLOCATE (LDOMDK, RDOMDK, LRDDK,  OMT1,   OMT2,   OMK1,   OMK2,   LPOMDK, RPOMDK, LRPDK,  POMS,   NTUDOM, ORGP,   ORGN,   ORGC)   !CSW 7/20/2021
  ...
  DEALLOCATE (CN,     INCN,   DTCN,   PRCN,   CSUM,   DLTMAX, QWDO,   TWDO,   SSS,    SEDRC,  TAUCR,  NTUISS,  XBR, FNO3SED, DYNSTRUC)  !CSW 7/20/2021
!  DEALLOCATE (SSFLOC, FLOCEQN)                                                                                          !SR 04/21/13
  ...
  DEALLOCATE (Z,      KB,     VNORM,  ANPR,   ANEQN,  APOM,   ACHLA,  AHSP,   AHSN,   AHSSI,  NTUALG)   !CSW 7/20/2021
  ...
  DEALLOCATE (VOLUME_BALANCE, DETAILED_ICE,         ICE_CALC,                ALLOW_ICE,       PH_CALC)     ! ICE_IN,       RC/SW 4/28/11
